...
modifier_bonus_hoodwink_swallow = class({})

----------------------------------------------------------------------------------

function modifier_bonus_hoodwink_swallow:IsHidden()
	return true
end

----------------------------------------------------------------------------------

function modifier_bonus_hoodwink_swallow:IsPurgable()
	return false
end
...
function modifier_bonus_hoodwink_swallow:OnCreated( kv )
	if IsServer() then
		--Cast effect
...
function modifier_bonus_hoodwink_swallow:OnIntervalThink()
	if IsServer() then
...
function modifier_bonus_hoodwink_swallow:OnDestroy()
	if IsServer() then
...
function modifier_bonus_hoodwink_swallow:CheckState()
	local state =
	{
