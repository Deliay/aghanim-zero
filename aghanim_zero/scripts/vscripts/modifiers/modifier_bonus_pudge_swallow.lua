...
modifier_bonus_pudge_swallow = class({})

----------------------------------------------------------------------------------

function modifier_bonus_pudge_swallow:IsHidden()
	return true
end

----------------------------------------------------------------------------------

function modifier_bonus_pudge_swallow:IsPurgable()
	return false
end
...
function modifier_bonus_pudge_swallow:OnCreated( kv )
	if IsServer() then
		--Cast effect
		...
		EmitSoundOn( "Hero_Pudge.Swallow", self:GetCaster() );
...
function modifier_bonus_pudge_swallow:OnIntervalThink()
	if IsServer() then
...
function modifier_bonus_pudge_swallow:OnDestroy()
	if IsServer() then
...
function modifier_bonus_pudge_swallow:CheckState()
	local state =
	{
