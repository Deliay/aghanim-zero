modifier_creature_bonus_room_mine = class({})

--------------------------------------------------------------------------------

function modifier_creature_bonus_room_mine:IsPurgable()
	return false;
end

--------------------------------------------------------------------------------

function modifier_creature_bonus_room_mine:IsHidden()
	return true;
end


function modifier_creature_bonus_room_mine:GetEffectName()
	return "particles/items2_fx/satanic_buff.vpcf"
end

--------------------------------------------------------------------------------

function modifier_creature_bonus_room_mine:OnCreated( kv )
...
function modifier_creature_bonus_room_mine:DeclareFunctions()
	local funcs = 
	{
...
function modifier_creature_bonus_room_mine:OnIntervalThink()
...
function modifier_creature_bonus_room_mine:OnDeath( params )
	if IsServer() then
...
function modifier_creature_bonus_room_mine:CheckState()
	local state = {}
	if IsServer()  then
...
function modifier_creature_bonus_room_mine:GetPriority()
	return MODIFIER_PRIORITY_SUPER_ULTRA
end

--------------------------------------------------------------------------------

function modifier_creature_bonus_room_mine:GetVisualZDelta( params )
	return 50
end
