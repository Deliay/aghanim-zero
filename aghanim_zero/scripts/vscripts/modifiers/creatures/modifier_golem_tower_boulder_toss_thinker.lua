...
modifier_golem_tower_boulder_toss_thinker = class({})

----------------------------------------------------------------------------------------

function modifier_golem_tower_boulder_toss_thinker:OnCreated( kv )
	if IsServer() then
...
function modifier_golem_tower_boulder_toss_thinker:OnImpact()
	if IsServer() then
...
function modifier_golem_tower_boulder_toss_thinker:OnIntervalThink()
	if IsServer() then
