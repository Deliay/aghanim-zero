modifier_aghslab_phantom_lancer_spirit_lance = class({})

--------------------------------------------------------------------------------

function modifier_aghslab_phantom_lancer_spirit_lance:IsHidden()
	return true
end

-----------------------------------------------------------------------------------------

function modifier_aghslab_phantom_lancer_spirit_lance:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_aghslab_phantom_lancer_spirit_lance:GetPriority()
	return MODIFIER_PRIORITY_ULTRA + 10001
end

--------------------------------------------------------------------------------

function modifier_aghslab_phantom_lancer_spirit_lance:CheckState()
	local state = 
	{
...
function modifier_aghslab_phantom_lancer_spirit_lance:GetEffectName()
...
function modifier_aghslab_phantom_lancer_spirit_lance:GetEffectAttachType()
...
function modifier_aghslab_phantom_lancer_spirit_lance:OnCreated( kv )
...
function modifier_aghslab_phantom_lancer_spirit_lance:OnDestroy()
	if IsServer() then	
