modifier_amoeba_boss_acid_spray_thinker = class({})

--------------------------------------------------------------------------------

function modifier_amoeba_boss_acid_spray_thinker:IsHidden()
	return true
end

--------------------------------------------------------------------------------

function modifier_amoeba_boss_acid_spray_thinker:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_amoeba_boss_acid_spray_thinker:OnCreated( kv )
	self:OnRefresh( kv )
...
function modifier_amoeba_boss_acid_spray_thinker:OnRefresh( kv )
	if IsServer() then
		...
		print( 'modifier_amoeba_boss_acid_spray_thinker:OnRefresh( kv ) - tick_rate = ' .. self.tick_rate .. ', damage = ' .. self.damage .. ', radius = ' .. self.radius .. ', duration ' .. self.duration )
...
function modifier_amoeba_boss_acid_spray_thinker:OnIntervalThink()
	if IsServer() then
...
function modifier_amoeba_boss_acid_spray_thinker:OnDestroy()
	if IsServer() then
