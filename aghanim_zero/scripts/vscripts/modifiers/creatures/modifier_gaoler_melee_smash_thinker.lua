...
modifier_gaoler_melee_smash_thinker = class({})

-----------------------------------------------------------------------------

function modifier_gaoler_melee_smash_thinker:OnCreated( kv )
	if IsServer() then
...
function modifier_gaoler_melee_smash_thinker:OnIntervalThink()
	if IsServer() then
...
function modifier_gaoler_melee_smash_thinker:OnDestroy()
	if IsServer() then
