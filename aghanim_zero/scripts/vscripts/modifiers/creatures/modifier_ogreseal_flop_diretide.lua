...
modifier_ogreseal_flop_diretide = class({})
...
function modifier_ogreseal_flop_diretide:IsStunDebuff()
	return true
end

--------------------------------------------------------------------------------

function modifier_ogreseal_flop_diretide:IsHidden()
	return true
end

--------------------------------------------------------------------------------

function modifier_ogreseal_flop_diretide:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_ogreseal_flop_diretide:RemoveOnDeath()
	return false
end

--------------------------------------------------------------------------------

function modifier_ogreseal_flop_diretide:OnCreated( kv )
	if IsServer() then
...
function modifier_ogreseal_flop_diretide:OnDestroy()
	if IsServer() then
...
function modifier_ogreseal_flop_diretide:DeclareFunctions()
	local funcs = 
	{
...
function modifier_ogreseal_flop_diretide:CheckState()
	local state =
	{
...
function modifier_ogreseal_flop_diretide:UpdateHorizontalMotion( me, dt )
	if IsServer() then
...
function modifier_ogreseal_flop_diretide:UpdateVerticalMotion( me, dt )
	if IsServer() then
...
function modifier_ogreseal_flop_diretide:OnHorizontalMotionInterrupted()
	if IsServer() then
...
function modifier_ogreseal_flop_diretide:OnVerticalMotionInterrupted()
	if IsServer() then
		self:Destroy()
	end
end
...
function modifier_ogreseal_flop_diretide:GetOverrideAnimation( params )
