...
if CMapEncounter_RuinousTraps == nil then
	CMapEncounter_RuinousTraps = class( {}, {}, CMapEncounter_TrapBase )
end

--------------------------------------------------------------------------------

function CMapEncounter_RuinousTraps:GetPreviewUnit()
	return "npc_dota_arrow_trap"
end

--------------------------------------------------------------------------------

function CMapEncounter_RuinousTraps:CheckForCompletion()
...
function CMapEncounter_RuinousTraps:DisableTraps()
...
return CMapEncounter_RuinousTraps
