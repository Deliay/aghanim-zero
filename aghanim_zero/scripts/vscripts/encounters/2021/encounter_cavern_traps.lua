...
if CMapEncounter_CavernTraps == nil then
	CMapEncounter_CavernTraps = class( {}, {}, CMapEncounter_TrapBase )
end

--------------------------------------------------------------------------------

function CMapEncounter_CavernTraps:GetPreviewUnit()
	return "npc_dota_breathe_fire_trap"
end

--------------------------------------------------------------------------------

function CMapEncounter_CavernTraps:CheckForCompletion()
...
function CMapEncounter_CavernTraps:DisableTraps()
...
return CMapEncounter_CavernTraps
