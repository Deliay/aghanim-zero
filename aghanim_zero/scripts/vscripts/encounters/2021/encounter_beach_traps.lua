...
if CMapEncounter_BeachTraps == nil then
	CMapEncounter_BeachTraps = class( {}, {}, CMapEncounter_TrapBase )
end

--------------------------------------------------------------------------------

function CMapEncounter_BeachTraps:GetPreviewUnit()
	return "npc_dota_arrow_trap"
end

--------------------------------------------------------------------------------

function CMapEncounter_BeachTraps:CheckForCompletion()
...
function CMapEncounter_BeachTraps:DisableTraps()
...
return CMapEncounter_BeachTraps
