...
if CMapEncounter_RegalTraps == nil then
	CMapEncounter_RegalTraps = class( {}, {}, CMapEncounter_TrapBase )
end

--------------------------------------------------------------------------------

function CMapEncounter_RegalTraps:GetPreviewUnit()
	return "npc_dota_breathe_fire_trap"
end

--------------------------------------------------------------------------------

function CMapEncounter_RegalTraps:CheckForCompletion()
...
function CMapEncounter_RegalTraps:DisableTraps()
...
return CMapEncounter_RegalTraps
