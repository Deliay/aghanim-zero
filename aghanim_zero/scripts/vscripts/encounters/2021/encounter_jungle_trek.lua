...
if CMapEncounter_JungleTrek == nil then
	CMapEncounter_JungleTrek = class( {}, {}, CMapEncounter )
end

--------------------------------------------------------------------------------


function CMapEncounter_JungleTrek:Precache( context )
...
function CMapEncounter_JungleTrek:constructor( hRoom, szEncounterName )
...
function CMapEncounter_JungleTrek:InitializeObjectives()
	CMapEncounter.InitializeObjectives( self )
end

--------------------------------------------------------------------------------

function CMapEncounter_JungleTrek:GetPreviewUnit()
	return "npc_dota_creature_huskar"
end

--------------------------------------------------------------------------------

function CMapEncounter_JungleTrek:Start()
...
function CMapEncounter_JungleTrek:OnSpawnerFinished( hSpawner, hSpawnedUnits )
...
return CMapEncounter_JungleTrek
