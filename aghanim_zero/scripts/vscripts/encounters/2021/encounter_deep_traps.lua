...
if CMapEncounter_DeepTraps == nil then
	CMapEncounter_DeepTraps = class( {}, {}, CMapEncounter_TrapBase )
end

--------------------------------------------------------------------------------

function CMapEncounter_DeepTraps:GetPreviewUnit()
	return "npc_dota_breathe_fire_trap"
end

--------------------------------------------------------------------------------

function CMapEncounter_DeepTraps:CheckForCompletion()
...
function CMapEncounter_DeepTraps:DisableTraps()
...
return CMapEncounter_DeepTraps
