...
if CMapEncounter_IcyPools == nil then
	CMapEncounter_IcyPools = class( {}, {}, CMapEncounter )
end

--------------------------------------------------------------------------------


function CMapEncounter_IcyPools:constructor( hRoom, szEncounterName )
...
function CMapEncounter_IcyPools:GetPreviewUnit()
...
function CMapEncounter_IcyPools:Start()
...
function CMapEncounter_IcyPools:InitializeObjectives()
...
function CMapEncounter_IcyPools:OnSpawnerFinished( hSpawner, hSpawnedUnits )
...
function CMapEncounter_IcyPools:MustKillForEncounterCompletion( hEnemyCreature )
