...
if CMapEncounter_MysticalTraps == nil then
	CMapEncounter_MysticalTraps = class( {}, {}, CMapEncounter_TrapBase )
end

--------------------------------------------------------------------------------

function CMapEncounter_MysticalTraps:GetPreviewUnit()
	return "npc_dota_arrow_trap"
end

--------------------------------------------------------------------------------

function CMapEncounter_MysticalTraps:CheckForCompletion()
...
function CMapEncounter_MysticalTraps:DisableTraps()
...
return CMapEncounter_MysticalTraps
