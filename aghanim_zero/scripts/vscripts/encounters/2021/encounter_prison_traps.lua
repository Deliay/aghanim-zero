...
if CMapEncounter_PrisonTraps == nil then
	CMapEncounter_PrisonTraps = class( {}, {}, CMapEncounter_TrapBase )
end

--------------------------------------------------------------------------------

function CMapEncounter_PrisonTraps:GetPreviewUnit()
	return "npc_dota_breathe_fire_trap"
end

--------------------------------------------------------------------------------

function CMapEncounter_PrisonTraps:CheckForCompletion()
...
function CMapEncounter_PrisonTraps:DisableTraps()
...
return CMapEncounter_PrisonTraps
