...
if CMapEncounter_BossRizzrick == nil then
	CMapEncounter_BossRizzrick = class( {}, {}, CMapEncounter_BossBase )
end

--------------------------------------------------------------------------------

function CMapEncounter_BossRizzrick:constructor( hRoom, szEncounterName )
...
function CMapEncounter_BossRizzrick:GetPreviewUnit()
	return "npc_dota_boss_timbersaw"
end

--------------------------------------------------------------------------------

function CMapEncounter_BossRizzrick:Precache( context )
...
function CMapEncounter_BossRizzrick:GetBossIntroVoiceLine()
...
function CMapEncounter_BossRizzrick:OnEncounterLoaded()
	CMapEncounter_BossBase.OnEncounterLoaded( self )
end

--------------------------------------------------------------------------------

function CMapEncounter_BossRizzrick:OnThink()
	CMapEncounter_BossBase.OnThink( self )
end

--------------------------------------------------------------------------------

function CMapEncounter_BossRizzrick:MustKillForEncounterCompletion( hEnemyCreature )
...
function CMapEncounter_BossRizzrick:OnBossSpawned( hBoss )
...
function CMapEncounter_BossRizzrick:OnBossKilled( hBoss, hAttacker )
...
function CMapEncounter_BossRizzrick:GetLaughLine()
...
function CMapEncounter_BossRizzrick:GetKillTauntLine()
	local szLines = 
	{
...
function CMapEncounter_BossRizzrick:GetAbilityUseLine( szAbilityName )
...
return CMapEncounter_BossRizzrick
